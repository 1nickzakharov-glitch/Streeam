...
async function runHardTests() {
  ...
  // 4. Large multi-step sprint checklist init
  const planItems = [{ text: 'Create ThemeContext', done: false }, { text: 'Add toggle component', done: false }, { text: 'Write E2E tests', done: false }];
  const scenarios = [
